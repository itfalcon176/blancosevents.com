...
export const TestimonialsPageContent: React.FC = () => {
  const testimonials = [
    ...
    },
    {
      ...
      quote: 'The attention to detail, the floral design and the ambiance were beyond our expectations. Jessica and her team made the entire process so easy.',
    ...
    },
    {
      ...
      quote: 'Jessica and her team are master designers. The styling was sophisticated and captured our personalities perfectly. Thank you for a beautiful memory.',
  ...
  return (
    <div className="w-full bg-[#FAF8F5] text-[#222222] overflow-hidden">
      ...
      {/* ---------------------------------------------------- */}
      <section className="py-6 bg-white border-y border-[#E8DFC5]/50 overflow-hidden">
        <div className="max-w-[1550px] mx-auto px-4 sm:px-6 lg:px-8">
          {/* Header Title with Lines */}
          <div className="flex items-center justify-center gap-3.5 mb-4 w-full">
