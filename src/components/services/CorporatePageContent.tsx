...
import { ArrowRight, Sparkles, Building, Briefcase, Trophy, Globe } from 'lucide-react';

export const CorporatePageContent: React.FC = () => {
  const offerings = [
    {
      title: 'Product & Brand Launches',
      desc: 'Immersive stage designs, customized lighting backdrops, and media walls tailored to highlight your brand identity.',
      icon: Building,
    },
    {
      title: 'Gala Dinners & Awards',
      desc: 'Sophisticated VIP dining tables, state-of-the-art staging, and elegant ambient floral designs for award nights.',
      icon: Trophy,
    },
    {
      title: 'Conferences & Seminars',
      desc: 'Flawless corporate arrangements including high-definition LED displays, clean registration spaces, and custom backdrops.',
      icon: Briefcase,
    },
    {
      title: 'Brand Activation Zones',
      desc: 'Pop-up experiences designed to engage guests and media influencers at luxury venues and public locations.',
      icon: Globe,
    },
  ];
    ...
    <div className="w-full bg-[#FAF8F5] text-[#222222] overflow-hidden">
      ...
      <section className="relative w-full bg-black min-h-[450px] lg:min-h-[520px] flex items-center border-b border-[#EADFC9]/50">
        <div 
          ...
          style={{ backgroundImage: "url('/portfolio-images/Corporate Events.webp')" }}
        />
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-12 w-full text-white">
          <div className="max-w-2xl text-left space-y-4">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif tracking-tight leading-tight">
              Corporate & <span className="text-[#C5A059]">Brand Events</span>
            </h1>
            <p className="text-sm sm:text-base text-neutral-300 font-light max-w-lg leading-relaxed">
              We translate brand values into high-end immersive real-world experiences, gala dinners, and product launches designed to inspire.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs font-bold tracking-[0.25em] text-[#C5A059] uppercase">Immersive Experiences</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-serif text-neutral-900 font-normal leading-tight">
              Elevating Corporate Standards to <span className="text-[#C5A059]">Luxury</span> Experiences
            </h2>
            <p className="text-sm text-neutral-600 font-light leading-relaxed">
              In the corporate world, first impressions are absolute. At Blanco\'s Events, we approach corporate functions, annual galas, and new product releases with the same artistic precision and premium styling as a luxury wedding.
            </p>
            <p className="text-sm text-neutral-600 font-light leading-relaxed">
              From managing complex light and sound engineering to custom-building stage sets and registration counters, our planning experts deliver seamless execution that respects your timeline and amplifies your brand identity.
            </p>
          </div>
          ...
          <div className="lg:col-span-5 relative aspect-[4/5] rounded-sm overflow-hidden border border-[#E8DFC5]/60 shadow-lg bg-neutral-100">
            <img 
              src="/blancosevents-image-home/coorporate.webp" 
              alt="Bespoke Corporate Gala Setup"
        ...
        <div className="relative max-w-[1100px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-xs text-neutral-300 font-light">
              Let\'s bring your absolute brand vision to reality.
            </p>
          </div>
          <a 
            href="/contact"
